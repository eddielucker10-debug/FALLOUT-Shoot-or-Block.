    ...
    <div className="absolute inset-0 z-20 flex items-center justify-center bg-background/85 p-6 backdrop-blur-sm">
      <div className="flex max-w-lg flex-col items-center gap-6 text-center">
        ...
        <p className="text-pretty text-sm leading-relaxed text-muted-foreground">
          Debris rains from above. Hold to <b className="text-[#67e8f9]">shoot</b>{" "}
          fragile targets, or raise your{" "}
          <b className="text-accent">shield</b> to block the heavy, armored ones.
          Match the right method for bonus loot, chase{" "}
          <b className="text-[#fbbf24]">rare drops</b>, and spend coins on{" "}
          <b className="text-primary">20 tiered upgrades</b>.
        </p>
        ...
        <p className="text-[11px] text-muted-foreground">
          {TOTAL_TYPES} types of debris · 6 rarities · 20 upgrades
        </p>
      </div>
    </div>
  )
    ...
    <div className="absolute inset-0 z-20 flex items-center justify-center bg-background/85 p-6 backdrop-blur-sm">
      <div className="flex w-full max-w-md flex-col items-center gap-5 text-center">
        ...
        <p className="text-sm text-muted-foreground">
          You banked{" "}
          <b className="text-[#fbbf24]">{coins.toLocaleString()} coins</b> —
          spend them, then launch again.
        </p>
